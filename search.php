                        						...
                        						<div class="col-xxl-14 col-xxl-offset-1">
													...
													<form action="" id="quick_search_form" method="post">                        			
														...
														<div class="form-group text-center">
															<input type="submit" value="<?php echo $lang['Search Now']; ?>" name="quick_sub" class="btn btn-default">
															<?php if(isset($_SESSION['user_id'])){ ?>
																<a class="btn btn-default gt-cursor" data-toggle="modal" data-target="#myModal" onClick="save_search();"><?php echo $lang['Save Search']; ?></a>
															<?php }?>
														</div>
                                    				</form>
                            					</div>
                        					...
                        					<div class="row">
                        						<div class="col-xxl-14 col-xxl-offset-1">
                        							...
                        							<form action="" id="baisc_search_form" method="post">
														...
														<div class="form-group text-center">
															<input type="submit" value="<?php echo $lang['Search Now']; ?>" name="basic_sub" class="btn btn-default">
															<?php if(isset($_SESSION['user_id'])){ ?>
																<a class="btn btn-default gt-cursor" data-toggle="modal" data-target="#myModal" onClick="save_search();"><?php echo $lang['Save Search']; ?></a>
															<?php }?>
											...
											<div class="row">
												<div class="col-xxl-14 col-xxl-offset-1">
                        							...
                        							<form action="" id="baisc_search_form" method="post">
														...
														<div class="form-group text-center">
															<input type="submit" value="<?php echo $lang['Search Now']; ?>" name="advance_sub" class="btn btn-default">
															<?php if(isset($_SESSION['user_id'])) { ?>
															<a class="btn btn-default gt-cursor" data-toggle="modal" data-target="#myModal" onClick="save_search();"><?php echo $lang['Saved Search']; ?></a>
															<?php }?>
														</div>
                                   					</form>     
                            					</div>
                        					...
                        					<div class="row">
                        						<div class="col-xxl-14 col-xxl-offset-1">
													...
													<form action="" id="baisc_search_form" method="post">
														...
														<div class="form-group text-center">
															<input type="submit" value="<?php echo $lang['Search Now']; ?>" name="keyword_sub" class="btn btn-default">
															<?php if(isset($_SESSION['user_id'])){?>
															<a class="btn btn-default gt-cursor" data-toggle="modal" data-target="#myModal" onClick="save_search();"><?php echo $lang['Save Search']; ?></a>
															<?php }?>
														</div>
                        					...
                        					<div class="row">
                        						<div class="col-xxl-14 col-xxl-offset-1">
                        							...
                        							<form action="" id="location_search_form" method="post">
                                    					...
                                    					<div class="form-group text-center">
                                          					<input type="submit" value="<?php echo $lang['Search Now']; ?>" name="location_sub" class="btn btn-default">
                                                       		<?php if(isset($_SESSION['user_id'])) {?>
                                                			<a class="btn btn-default gt-cursor" data-toggle="modal" data-target="#myModal" onClick="save_search();"><?php echo $lang['Save Search']; ?></a>
                                                			<?php }?>
                                      					</div>
                        					...
                        					<div class="row">
                        						<div class="col-xxl-14 col-xxl-offset-1">
                        							...
                        							<form action="" id="ocp_search_form" method="post">
														...
														<div class="form-group text-center">
															<input type="submit" value="<?php echo $lang['Search Now']; ?>" name="occupation_sub" class="btn btn-default">
															<?php  if(isset($_SESSION['user_id'])) { ?>
															<a class="btn btn-default gt-cursor" data-toggle="modal" data-target="#myModal" onClick="save_search();"><?php echo $lang['Save Search']; ?></a>
															<?php }?>
														</div>
