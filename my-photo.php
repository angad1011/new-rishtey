        			...
        			<div class="container margin-top-20">
            			<div class="row">
							...
							<div class="col-xxl-4 col-xl-4 gt-left-opt-msg">
								<a class="btn btn-default btn-block hidden-xxl hidden-xl gt-margin-bottom-20" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample" >
											...
											<div class="row">
												<div class="col-xxl-6 col-xxl-offset-5 col-xl-6 col-xxl-offset-5 col-md-12 col-md-offset-2 col-lg-6 col-lg-offset-5">
													<div class="col-xs-16 gtImageUpload">
														...
														<?php }}?> 
															<a href="#editPhoto1Modal" data-toggle="modal" class="btn btn-default btn-block gt-margin-bottom-10">
                        				...
                        				<div class="row">
											<div class="col-xxl-4 col-xs-8 col-md-4">
												<div class="gtImageUpload">
													...
													<a href="#editPhoto2Modal" data-toggle="modal" class="btn btn-default btn-block gt-margin-bottom-10">
											...
											<div class="col-xxl-4 col-xs-8 col-md-4">
												<div class="gtImageUpload">
													...
													<a href="#editPhoto3Modal" data-toggle="modal" class="btn btn-default btn-block gt-margin-bottom-10">
											...
											<div class="col-xxl-4 col-xs-8 col-md-4">
												<div class="gtImageUpload">
													...
													<a href="#editPhoto4Modal" data-toggle="modal" class="btn btn-default btn-block gt-margin-bottom-10">
											...
											<div class="col-xxl-4 col-xs-8 col-md-4">
												<div class="gtImageUpload">
													...
													<a href="#editPhoto5Modal" data-toggle="modal" class="btn btn-default btn-block gt-margin-bottom-10">
										...
										<div class="row margin-top-20">
											<div class="col-xxl-4 col-xs-8 col-md-4">
												<div class="gtImageUpload">
													...
													<a href="#editPhoto6Modal" data-toggle="modal" class="btn btn-default btn-block gt-margin-bottom-10">
