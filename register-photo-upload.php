										...
										?>
								   		<div class="row">
											<div class="col-xxl-3 col-xxl-offset-13">
												<a class="btn btn-default btn-block" href="aadhaar_upload"> <?php echo $lang['Skip']; ?> <i class="fa fa-caret-right"></i></a>
											</div>
										</div>
										<?php } ?>
											...
											<div class="row">
											   <div class="col-xxl-6 col-xl-16 col-xxl-offset-5 text-center">
													<div class="row">
														...
														<input type="submit" name="submit" value="<?php echo $lang['Upload & Continue']; ?>" class="btn btn-default inIndexRegBtn btn-block inPhotoUploadBtn mt-20">
													</div>
												</div>
											</div>
										</form>
