      				...
      				<div class="container margin-top-20">
        				<div class="row">
          					<aside class="col-xxl-4 col-xl-4 col-xs-16">
            					<a class="btn btn-default btn-block hidden-xxl hidden-xl gt-margin-bottom-20 gt-margin-top-15" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample" >
          					...
          					<div class="col-xxl-12 col-xl-12 col-xs-16">
								...
								<div class="col-xl-16 text-center mb-20">
									<a class="btn btn-default" data-toggle="collapse" href="#collapseCustomMatch" role="button" aria-expanded="false" aria-controls="collapseCustomMatch">
