...
<div class="alert alert-warning" role="alert">
        ...
        <div class="col-xxl-16 col-xs-16"></div>
            <div class="col-xxl-16 col-xs-16">
                ...
                <?php if (isset($_SESSION['user_id'])) { ?>
                    <a data-toggle="modal" data-target="#myModal" onClick="save_search();" class="btn btn-default gt-cursor">
    ...
    <div class="col-xs-16 text-right">
        <div class="buttons">
            <button class="grid btn btn-default">
                <i class="fa fa-list gt-margin-right-5"></i><?php echo $lang['Grid View']; ?>
            </button>
            <button class="list btn btn-default">
