						 	...
						 	<div class="col-xxl-12 col-xxl-offset-2 gtRegister">
								...
								<div class="row">
									<div class="col-xxl-3 col-xxl-offset-13">
										<a class="btn btn-default btn-block" href="register-confirm-password"> <?php echo $lang['Skip']; ?> <i class="fa fa-caret-right"></i></a>
									</div>
								</div>
								<?php } ?>
								<div class="row">
									...
									<form class="col-xxl-10 gt-margin-top-50" name="" method="post" enctype="multipart/form-data">
										...
										<input type="Submit" value="Upload" name="submit" class="btn btn-default inIndexRegBtn">
