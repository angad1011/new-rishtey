					...
					<div class="container gt-view-profile">
                        <div class="row">
                            <div class="col-xxl-3 col-xl-4 col-xs-16 col-sm-16">  
								...
								<a href="#morePhotos" class="btn btn-default btn-block mb-20 pt-10 pb-10" data-toggle="modal"><?php echo $lang['']; ?>View More Photos</a>
								<?php } ?>
								<!-- Modal more photos -->
                    ...
                    <div class="container gt-view-profile">
                    	<div class="row">
                            ...
                            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-5 col-sm-5" style="position: fixed; left: 43%; top: 20%; z-index: -1; opacity: 0;" id="edit_success">
                                <div class="col-xxl-13 col-xl-12 col-lg-16 col-md-16 col-sm-16 btn btn-default">
