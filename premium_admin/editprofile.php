                                                        ...
                                                        <div class="row">
                                                            <div class="col-xs-4">
                                                                <select class="form-control" name="mobile_code" id="mobile_code" data-validetta="required">
																	...
																	?>
																	<option value="+<?php echo $DatabaseCo->dbRow->phonecode; ?>" <?php if(isset($mobile_code_f)){ echo "selected"; }elseif($DatabaseCo->dbRow->phonecode == $row->mobile_code){ echo "selected";} ?> >+<?php echo $DatabaseCo->dbRow->phonecode; ?></option>
																	<?php } ?>                    
                                                                </select>
                                                            </div>
                                                            <div class="col-xs-8">
