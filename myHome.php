                                					...
                                					<div class="col-xxl-16 col-xs-16 col-lg-16">
                                        				...
                                        				<div class="col-xxl-10 col-lg-10 col-xs-16">
                                            				...
                                            				<?php
                                             				...
                                             				?>
																<button class="btn btn-default btn-block mt-5" onClick="sendreminder(<?php echo $sql_exp->ei_id ?>);" id="reminder<?php echo $sql_exp->ei_id; ?>" title="Send Reminder" >
                                            				...
                                            				<?php } else { ?>	
                                            					<button class="btn btn-default btn-block mt-5" onclick="ExpressInterest('<?php echo $Row->matri_id; ?>')" title="Send Interest" data-target="#myModal1" data-toggle="modal" data-backdrop="static" data-keyboard="false">
