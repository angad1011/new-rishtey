...
function sendreminder(expid) {
	$.ajax({
		...
		success: function (response) {
			...
			$('#loaderID').html('<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6" style="position: fixed; z-index: 9999; opacity: 1; top: 40%; left: 40%;" ><div class="col-lg-16 col-md-16 col-sm-16 btn btn-default"><font class="gt-margin-left-5">You have successfully sent reminder....  </font></div></div>');
